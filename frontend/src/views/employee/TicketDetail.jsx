...
import { ArrowLeft, User, Clock, RefreshCcw, Eye, AlertCircle, Hash, Info } from 'lucide-react';
...
const TicketDetail = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-5xl mx-auto pb-16 space-y-6">
      ...
      {/* Header Actions */}
      <div className="flex items-center gap-3 text-xs font-bold tracking-widest text-gray-500 mb-4 uppercase">
